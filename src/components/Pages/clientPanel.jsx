...
export default function ClientPanel() {
  return (
    <div className="min-h-screen bg-gray-100 p-8 text-sm">
      <h1 className="text-2xl font-bold mb-8">Test Cricket Live Score</h1>

      <div className="max-w-4xl mx-auto">
        <h2 className="font-bold text-lg mb-4">Red Dragons 1st Inning (376/10)</h2>
        ...
        <h2 className="font-bold text-lg mb-4">Blue Tigers 1st Inning(149/10)</h2>
        <table className="table-auto w-full mb-8 text-xs">
          <thead>
        ...
        <h2 className="font-bold text-lg mb-4">Red Dragons Bowling</h2>
        <table className="table-auto w-full mb-8 text-xs">
          <thead>
            <tr className="bg-red-400">
          ...
          <tbody>
            {bowlerDataIndia.map((bowler, index) => (
              <tr key={index} className="border-b">
        ...
        <h2 className="font-bold text-lg mb-4">Blue Tigers Bowling</h2>
        <table className="table-auto w-full mb-8 text-xs">
          <thead>
            <tr className="bg-blue-400">
              <th className="px-4 py-2">Bowler</th>
          ...
          <tbody>
            {bowlerDataBangladesh.map((bowler, index) => (
              <tr key={index} className="border-b">
                <td className="px-4 py-2">{bowler.name}</td>
                <td className="px-4 py-2">{bowler.overs}</td>
                <td className="px-4 py-2">{bowler.maidens}</td>
        ...
        <h2 className='font-bold'>Red Dragons lead by 227 Runs</h2>
      </div>
    </div>
  );
}